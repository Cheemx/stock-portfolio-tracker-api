...
func HandleBuyTransaction(buyQuant, oldQuant int, oldAvgPrice, currPrice float64) (newQuant int, totalInvested, newAvg, pnl, pnlPercentage float64) {
...
func HandleSellTransaction(sellQuant, oldQuant int, oldAvgPrice, currPrice float64) (newQuant int, totalInvested, newAvg, pnl, pnlPercentage float64) {
